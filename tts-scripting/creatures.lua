Creatures = {
	{
		Name = "Bubbcat",TexturePath = "images/creatures/bubblegum/bubbcat.png",CardType = "creature",Type = "Bubblegum",Health = 9,CatchRate = 12,Level = 1,Abilities = {"Once per turn you may restore 1 heart for every {{D:6}} in your roll."},AmountInDeck = 1
	},
	{
	...
	{
		Name = "Bubbster",Type = "Bubblegum",CardType = "creature",Health = 14,CatchRate = 19,Level = 3,Abilities = {"Every time your opponent uses a skill that does not damage this card, you may INCREMENT 1.","When you INCREMENT a {{D:6}} you may give 1 heart."},AmountInDeck = 1
	},
	{
